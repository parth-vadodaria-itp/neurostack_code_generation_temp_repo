...
class TestCalculator(unittest.TestCase):
    ...
    def test_square_positive_integers(self):
        """Test square of positive integers using custom loop logic."""
        self.assertEqual(self.calc.square(5), 25)
        self.assertEqual(self.calc.square(3), 9)
        self.assertEqual(self.calc.square(10), 100)
    
    def test_square_positive_floats(self):
        """Test square of positive floating point numbers."""
        self.assertAlmostEqual(self.calc.square(2.5), 6.25, places=5)
        self.assertAlmostEqual(self.calc.square(1.5), 2.25, places=5)
    
    def test_square_negative_numbers(self):
        """Test square of negative numbers (result should be positive)."""
        self.assertEqual(self.calc.square(-5), 25)
        self.assertEqual(self.calc.square(-3), 9)
